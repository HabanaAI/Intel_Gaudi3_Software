...
#ifndef ASIC_REG_STRUCTS_GAUDI2_TPC_NON_TENSOR_DESCRIPTOR_H_
#define ASIC_REG_STRUCTS_GAUDI2_TPC_NON_TENSOR_DESCRIPTOR_H_
...
#pragma pack(pop)
#endif /* ASIC_REG_STRUCTS_GAUDI2_TPC_NON_TENSOR_DESCRIPTOR_H_ */
