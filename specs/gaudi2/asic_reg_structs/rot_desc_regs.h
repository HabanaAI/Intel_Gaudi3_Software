...
#ifndef ASIC_REG_STRUCTS_GAUDI2_ROT_DESC_H_
#define ASIC_REG_STRUCTS_GAUDI2_ROT_DESC_H_
...
/*
 IN_IMG_START_ADDR_L 
 b'Input Image Start Addr Lower 32 bits'
*/
...
/*
 IN_IMG_START_ADDR_H 
 b'Input Image Start Addr Upper Bits'
*/
...
/*
 ...
 b'Output Image Start Addr Lower 32 bits'
*/
...
/*
 ...
 b'Output Image Start Addr Upper Bits'
*/
...
/*
 CFG 
 b'Configuration Ctrls for Rotation'
*/
...
/*
 IN_STRIDE 
 b'Input image horizontal stride'
*/
...
/*
 OUT_STRIDE 
 b'Output Image Horizontal Stride in Bytes'
*/
...
/*
 CPL_MSG_EN 
 b'LBW Complettion Message Enable'
*/
...
/*
 IDLE_STATE 
 b'Enable Power Loop/IdleMessages on start & end'
*/
...
/*
 CPL_MSG_ADDR 
 b'Addres for LBW Completion Message'
*/
...
/*
 CPL_MSG_DATA 
 b'Write Data for LBW Completion Message'
*/
...
/*
 CPL_MSG_AWUSER 
 b'LBW CPL MSG AWUSER'
*/
typedef struct reg_cpl_msg_awuser {
	union {
		struct {
			uint32_t val : 32;
		};
...
static_assert((sizeof(struct reg_cpl_msg_awuser) == 4), "reg_cpl_msg_awuser size is not 32-bit");
/*
 X_I_START_OFFSET 
...
/*
 X_I_FIRST 
 b'First pixel from first input image line required'
*/
...
/*
 Y_I_FIRST 
 b'First input image line required'
*/
...
/*
 Y_I 
 b'First & Last Lines of Inp Image (Yifirst,Yiend)'
*/
...
/*
 RSB_PAD_VAL 
 b'Input Image RSB Pad values for out of bound reques'
*/
...
/*
 HBW_ARUSER_HI 
 b'HBW ARUSER Fields - High'
*/
typedef struct reg_hbw_aruser_hi {
	union {
		struct {
			uint32_t val : 32;
		};
...
static_assert((sizeof(struct reg_hbw_aruser_hi) == 4), "reg_hbw_aruser_hi size is not 32-bit");
/*
 HBW_ARUSER_LO 
 b'HBW ARUSER Lower 32 bits.'
*/
typedef struct reg_hbw_aruser_lo {
	union {
		struct {
			uint32_t val : 32;
		};
...
static_assert((sizeof(struct reg_hbw_aruser_lo) == 4), "reg_hbw_aruser_lo size is not 32-bit");
/*
 HBW_AWUSER_HI 
 b'HBW AWUSER fields - High'
*/
typedef struct reg_hbw_awuser_hi {
	union {
		struct {
			uint32_t val : 32;
		};
...
static_assert((sizeof(struct reg_hbw_awuser_hi) == 4), "reg_hbw_awuser_hi size is not 32-bit");
/*
 HBW_AWUSER_LO 
 b'HBW AWUSER Fields - Low'
*/
typedef struct reg_hbw_awuser_lo {
	union {
		struct {
			uint32_t val : 32;
		};
...
static_assert((sizeof(struct reg_hbw_awuser_lo) == 4), "reg_hbw_awuser_lo size is not 32-bit");
/*
 OWM_CFG 
 b'CFG for Output Write Manager'
*/
...
/*
 PIXEL_PAD 
 b'Pad & mask values for input pixel size 0 to 16bits'
*/
...
/*
 PREC_SHIFT 
 b'fixed pt precisions for co-ordinate calc & interp'
*/
...
/*
 MAX_VAL 
 b'Maximum Pixel Value for Saturation Check'
*/
...
/*
 MRSB_CFG_0 
 b'CFG for Mesh Image Read Suspension Buffer'
*/
...
/*
 MRSB_PAD_VAL 
 b'Pad Value for Mesh Image Out of Bounds Requests'
*/
...
struct block_rot_desc {
	...
	struct rot_desc::reg_cpl_msg_awuser cpl_msg_awuser;
	...
	struct rot_desc::reg_hbw_aruser_hi hbw_aruser_hi;
	struct rot_desc::reg_hbw_aruser_lo hbw_aruser_lo;
	struct rot_desc::reg_hbw_awuser_hi hbw_awuser_hi;
	struct rot_desc::reg_hbw_awuser_lo hbw_awuser_lo;
...
typedef struct block_rot_desc {
	...
	reg_cpl_msg_awuser cpl_msg_awuser;
	...
	reg_hbw_aruser_hi hbw_aruser_hi;
	reg_hbw_aruser_lo hbw_aruser_lo;
	reg_hbw_awuser_hi hbw_awuser_hi;
	reg_hbw_awuser_lo hbw_awuser_lo;
	reg_owm_cfg owm_cfg;
...
#pragma pack(pop)
#endif /* ASIC_REG_STRUCTS_GAUDI2_ROT_DESC_H_ */
