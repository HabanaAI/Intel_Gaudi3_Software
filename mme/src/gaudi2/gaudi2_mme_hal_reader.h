#ifndef MME__GAUDI2_MME_HAL_READER_H
#define MME__GAUDI2_MME_HAL_READER_H
...
private:
    ...
    virtual MmeCommon::ChipType getChipType() const override { return MmeCommon::ChipType::e_mme_Gaudi2; }
    virtual unsigned getClkFreqMHz() const override { return 1650; };
...
#endif //MME__GAUDI2_MME_HAL_READER_H
