...
//
// This file is the hccl function implementation in libhcl.so/libg1hcl.so and called from libSynapse.so
// In case new functions are added to hccl.h, this file should be updated and synapse repo must be rebuilt
// The body of these functions is in hccl_common.cpp
//
