...
#ifndef ASIC_REG_STRUCTS_GAUDI3_SYNC_OBJECT_H_
#define ASIC_REG_STRUCTS_GAUDI3_SYNC_OBJECT_H_
...
/*
 MESSAGE 
 b'Sync object message meta data'
*/
...
#pragma pack(pop)
#endif /* ASIC_REG_STRUCTS_GAUDI3_SYNC_OBJECT_H_ */
