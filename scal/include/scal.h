...
int scal_nics_db_fifos_init_and_allocV2(const scal_handle_t scal, const scal_ibverbs_init_params* ibvInitParams, struct hlibdv_usr_fifo ** createdFifoBuffers, uint32_t * createdFifoBuffersCount);

struct hlibdv_usr_fifo_attr_tmp;
struct hlibdv_usr_fifo_attr;
int scal_get_nics_db_fifos_params(const scal_handle_t scal, struct hlibdv_usr_fifo_attr* nicUserDbFifoParams, unsigned* nicUserDbFifoParamsCount);
