...
struct TpcTensorsDesc
{
    ...
    WrReg32_WrRegBulk_WrReg32<firstRegAddr, regBulkSize> wrRegBulk;
...
{
    using WriteRegBulkCommands = WrReg32_WrRegBulk_WrReg32<tpc_regs::inclusiveFirst, tpc_regs::descSize>;
