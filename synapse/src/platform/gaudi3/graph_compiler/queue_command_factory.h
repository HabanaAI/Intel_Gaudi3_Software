...
public:
    ...
    virtual QueueCommandPtr getCpDma(deviceAddrOffset addrOffset, uint64_t size, uint32_t predicate = 0) const override;
    ...
    virtual QueueCommandPtr getDynamicExecute(QueueCommandPtr               execute,
                                              ...
                                              BypassType                    enableBypass) const override;

    virtual QueueCommandPtr getResetSobs(unsigned target, unsigned totalNumEngs) const override;

    virtual QueueCommandPtr getMcidRollover(unsigned target) const override;
