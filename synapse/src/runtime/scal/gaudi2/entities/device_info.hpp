...
public:
    ...
    virtual bool isQueueSelectorMaskSupported() const override { return false; };
    ...
    virtual bool isDummyMessageRequiredForMonitorForLongSO() const override { return true; };
