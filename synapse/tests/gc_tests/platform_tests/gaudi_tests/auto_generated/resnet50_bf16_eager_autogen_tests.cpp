...
namespace
{
struct SynGaudi2ResNetTestBFloat16 : SynGaudi2ResNetTestEager
{
    void conv2dFwd();
    void batchNorm2dFwd();
    void reluFwd();
...
void SynGaudi2ResNetTestBFloat16::conv2dFwd()
{
...
void SynGaudi2ResNetTestBFloat16::batchNorm2dFwd()
{
    const bool eagerMode = true;
    ...
    /*************
     * worker_0_bn1 node
     * inputs: [worker_0_conv1_output[64, 112, 112, 64](dtype=bf16), worker_0_bn1_bias[64](dtype=float32), worker_0_bn1_weight[64](dtype=float32), worker_0_bn1_running_mean[64](dtype=float32), worker_0_bn1_running_var[64](dtype=float32)]
     * output: [worker_0_bn1_output(64, 112, 112, 64)(dtype=bf16), worker_0_bn1_saved_mean(1, 1, 1, 64)(dtype=float32), worker_0_bn1_saved_var(1, 1, 1, 64)(dtype=float32)]
     *************/
    ...
    status = synNodeCreate(graphHandle, worker_0_bn1_in_vec, worker_0_bn1_out_vec, 5, 3, (void *)&worker_0_bn1_kernel_params, sizeof(worker_0_bn1_kernel_params), "batch_norm_fwd_bf16", "worker_0_bn1", nullptr, nullptr);
...
void SynGaudi2ResNetTestBFloat16::reluFwd()
{
    const bool eagerMode = true;
    ...
    status = synNodeCreate(graphHandle, worker_0_relu_in_vec, worker_0_relu_out_vec, 1, 1, nullptr, 0, "relu_fwd_bf16", "worker_0_relu", nullptr, nullptr);
...
void SynGaudi2ResNetTestBFloat16::maxPool2dFwd()
{
    const bool eagerMode = true;
    ...
    synLaunchTensorInfo worker_0_maxpoolmax_indices_tr_info {};
    {
        ...
        const unsigned                bytes = prod(dims) * sizeof(uint16_t);
    ...
    status = synNodeCreate(graphHandle, worker_0_maxpool_in_vec, worker_0_maxpool_out_vec, 1, 2, (void *)&worker_0_maxpool_kernel_params, sizeof(worker_0_maxpool_kernel_params), "maxpool_2d_fwd_bf16", "worker_0_maxpool", nullptr, nullptr);
...
void SynGaudi2ResNetTestBFloat16::avgPool2dFwd()
{
    const bool eagerMode = true;
    ...
    status = synNodeCreate(graphHandle, worker_0_avgpool_in_vec, worker_0_avgpool_out_vec, 1, 1, (void *)&worker_0_avgpool_kernel_params, sizeof(worker_0_avgpool_kernel_params), "avg_pool_2d_fwd_bf16", "worker_0_avgpool", nullptr, nullptr);
...
void SynGaudi2ResNetTestBFloat16::linearFwd()
{
    const bool eagerMode = true;
    ...
    /*************
     * worker_0_fc node
     * inputs: [worker_0_avgpool_output(64, 1, 1, 2048)(dtype=bf16), worker_0_fc_weight(1, 1, 2048, 1000)(dtype=bf16), worker_0_fc_bias[1000](dtype=bf16)]
     * output: [worker_0_fc_output(64, 1, 1, 1000)(dtype=bf16)]
     *************/
...
void SynGaudi2ResNetTestBFloat16::crossEntropyLossLogSoftmax()
{
    const bool eagerMode = true;
     ...
     * inputs: [worker_0_fc_output[64, 1000](dtype=bf16), target[64](dtype=int32)]
    ...
    status = synNodeCreate(graphHandle, cross_entropy_loss0_log_softmax_in_vec, cross_entropy_loss0_log_softmax_out_vec, 2, 2, (void *)&cross_entropy_loss0_log_softmax_kernel_params, sizeof(cross_entropy_loss0_log_softmax_kernel_params), "softmax_cross_entropy_fwd_bf16", "cross_entropy_loss0_log_softmax", nullptr, nullptr);
...
void SynGaudi2ResNetTestBFloat16::crossEntropyLossLogSoftmaxBwd()
{
    const bool eagerMode = true;
    ...
    status = synNodeCreate(graphHandle, cross_entropy_loss0_log_softmax_bwd_in_vec, cross_entropy_loss0_log_softmax_bwd_out_vec, 2, 1, (void *)&cross_entropy_loss0_log_softmax_bwd_kernel_params, sizeof(cross_entropy_loss0_log_softmax_bwd_kernel_params), "softmax_cross_entropy_bwd_bf16", "cross_entropy_loss0_log_softmax_bwd", nullptr, nullptr);
...
void SynGaudi2ResNetTestBFloat16::linearDedx()
{
    const bool eagerMode = true;
     ...
     * inputs: [cross_entropy_loss0_grad_input(64, 1, 1, 1000)(dtype=bf16), worker_0_fc_weight(1, 1, 2048, 1000)(dtype=bf16)]
     * output: [worker_0_fc_grad_input(64, 1, 1, 2048)(dtype=bf16)]
     *************/
...
void SynGaudi2ResNetTestBFloat16::linearDedw()
{
    const bool eagerMode = true;
     ...
     * inputs: [cross_entropy_loss0_grad_input(64, 1, 1, 1000)(dtype=bf16), worker_0_avgpool_output(64, 1, 1, 2048)(dtype=bf16)]
...
void SynGaudi2ResNetTestBFloat16::linearDedb()
{
    const bool eagerMode = true;
    ...
    status = synNodeCreate(graphHandle, worker_0_fc_dedb_in_vec, worker_0_fc_dedb_out_vec, 1, 1, (void *)&worker_0_fc_dedb_kernel_params, sizeof(worker_0_fc_dedb_kernel_params), "reduce_sum_fwd_bf16", "worker_0_fc_dedb", nullptr, nullptr);
...
void SynGaudi2ResNetTestBFloat16::avgPool2dBwd()
{
    const bool eagerMode = true;
    ...
    status = synNodeCreate(graphHandle, worker_0_avgpool_bwd_in_vec, worker_0_avgpool_bwd_out_vec, 1, 1, (void *)&worker_0_avgpool_bwd_kernel_params, sizeof(worker_0_avgpool_bwd_kernel_params), "avg_pool_2d_bwd_bf16", "worker_0_avgpool_bwd", nullptr, nullptr);
...
void SynGaudi2ResNetTestBFloat16::reluBwd()
{
    const bool eagerMode = true;
     ...
     * inputs: [worker_0_avgpool_grad_input[64, 7, 7, 2048](dtype=bf16), layer4_2_relu3_output[64, 7, 7, 2048](dtype=bf16)]
     * output: [layer4_2_relu3_grad_input(64, 7, 7, 2048)(dtype=bf16)]
     *************/
    ...
    status = synNodeCreate(graphHandle, layer4_2_relu3_bwd_in_vec, layer4_2_relu3_bwd_out_vec, 2, 1, nullptr, 0, "relu_bwd_bf16", "layer4_2_relu3_bwd", nullptr, nullptr);
...
void SynGaudi2ResNetTestBFloat16::addResidualBwd()
{
    const bool eagerMode = true;
     ...
     * output: [layer4_2_add_residual_grad_input0(64, 7, 7, 2048)(dtype=bf16), layer4_2_add_residual_grad_input1(64, 7, 7, 2048)(dtype=bf16)]
     *************/
    ...
    status = synNodeCreate(graphHandle, layer4_2_add_residual_bwd_in_vec, layer4_2_add_residual_bwd_out_vec, 1, 2, nullptr, 0, "add_bwd_bf16", "layer4_2_add_residual_bwd", nullptr, nullptr);
...
void SynGaudi2ResNetTestBFloat16::batchNorm2dBwd()
{
    const bool eagerMode = true;
     ...
     * inputs: [layer4_2_conv3_output[64, 7, 7, 2048](dtype=bf16), layer4_2_add_residual_grad_input0[64, 7, 7, 2048](dtype=bf16), layer4_2_bn3_saved_mean[1, 1, 1, 2048](dtype=float32), layer4_2_bn3_saved_var[1, 1, 1, 2048](dtype=float32), layer4_2_bn3_weight[2048](dtype=float32)]
     * output: [layer4_2_bn3_grad_input(64, 7, 7, 2048)(dtype=bf16), layer4_2_bn3_bias_grad(2048,)(dtype=float32), layer4_2_bn3_weight_grad(2048,)(dtype=float32)]
     *************/
    ...
    status = synNodeCreate(graphHandle, layer4_2_bn3_bwd_in_vec, layer4_2_bn3_bwd_out_vec, 5, 3, nullptr, 0, "batch_norm_bwd_bf16", "layer4_2_bn3_bwd", nullptr, nullptr);
...
void SynGaudi2ResNetTestBFloat16::conv2DDedx()
{
    const bool eagerMode = true;
...
void SynGaudi2ResNetTestBFloat16::conv2DDedw()
{
    const bool eagerMode = true;
...
void SynGaudi2ResNetTestBFloat16::addResidualFwd()
{
    const bool eagerMode = true;
     ...
     * inputs: [layer1_0_conv1_grad_input[64, 56, 56, 64](dtype=bf16), layer1_downsample_grad_input[64, 56, 56, 64](dtype=bf16)]
     * output: [layer1_0_residual_upstream_grad_input(64, 56, 56, 64)(dtype=bf16)]
     *************/
    ...
    status = synNodeCreate(graphHandle, layer1_0_add_residual_fwd1_in_vec, layer1_0_add_residual_fwd1_out_vec, 2, 1, nullptr, 0, "add_fwd_bf16", "layer1_0_add_residual_fwd1", nullptr, nullptr);
...
void SynGaudi2ResNetTestBFloat16::maxPool2dBwd()
{
    const bool eagerMode = true;
     ...
     * inputs: [layer1_0_residual_upstream_grad_input[64, 56, 56, 64](dtype=bf16), worker_0_maxpoolmax_indices[64, 56, 56, 64](dtype=uint16)]
     * output: [worker_0_maxpool_grad_input(64, 112, 112, 64)(dtype=bf16)]
     *************/
    ...
    status = synNodeCreate(graphHandle, worker_0_maxpool_bwd_in_vec, worker_0_maxpool_bwd_out_vec, 2, 1, (void *)&worker_0_maxpool_bwd_kernel_params, sizeof(worker_0_maxpool_bwd_kernel_params), "maxpool_2d_bwd_bf16", "worker_0_maxpool_bwd", nullptr, nullptr);
...
TEST_F_GC(SynGaudi2ResNetTestBFloat16, resnet50_Conv2D_fwd_eager)
{
    conv2dFwd();
}

TEST_F_GC(SynGaudi2ResNetTestBFloat16, resnet50_Conv2D_fwd_eager_ASIC_CI)
{
    conv2dFwd();
}

TEST_F_GC(SynGaudi2ResNetTestBFloat16, resnet50_BatchNorm2D_fwd_eager_ASIC_CI)
{
    batchNorm2dFwd();
}

TEST_F_GC(SynGaudi2ResNetTestBFloat16, resnet50_BatchNorm2D_fwd_eager)
{
    batchNorm2dFwd();
}

TEST_F_GC(SynGaudi2ResNetTestBFloat16, resnet50_ReLU_fwd_eager)
{
    reluFwd();
}

TEST_F_GC(SynGaudi2ResNetTestBFloat16, resnet50_ReLU_fwd_eager_ASIC_CI)
{
    reluFwd();
}

TEST_F_GC(SynGaudi2ResNetTestBFloat16, resnet50_MaxPool2D_fwd_eager)
{
    maxPool2dFwd();
}

TEST_F_GC(SynGaudi2ResNetTestBFloat16, resnet50_MaxPool2D_fwd_eager_ASIC_CI)
{
    maxPool2dFwd();
}

TEST_F_GC(SynGaudi2ResNetTestBFloat16, resnet50_AvgPool2D_fwd_eager)
{
    avgPool2dFwd();
}

TEST_F_GC(SynGaudi2ResNetTestBFloat16, resnet50_AvgPool2D_fwd_eager_ASIC_CI)
{
    avgPool2dFwd();
}

TEST_F_GC(SynGaudi2ResNetTestBFloat16, resnet50_Linear_fwd_eager)
{
    linearFwd();
}

TEST_F_GC(SynGaudi2ResNetTestBFloat16, resnet50_Linear_fwd_eager_ASIC_CI)
{
    linearFwd();
}

TEST_F_GC(SynGaudi2ResNetTestBFloat16, resnet50_CrossEntropyLoss_log_softmax_eager)
{
    crossEntropyLossLogSoftmax();
}

TEST_F_GC(SynGaudi2ResNetTestBFloat16, resnet50_CrossEntropyLoss_log_softmax_eager_ASIC_CI)
{
    crossEntropyLossLogSoftmax();
}

TEST_F_GC(SynGaudi2ResNetTestBFloat16, resnet50_CrossEntropyLoss_log_softmax_bwd_eager)
{
    crossEntropyLossLogSoftmaxBwd();
}

TEST_F_GC(SynGaudi2ResNetTestBFloat16, resnet50_CrossEntropyLoss_log_softmax_bwd_eager_ASIC_CI)
{
    crossEntropyLossLogSoftmaxBwd();
}

TEST_F_GC(SynGaudi2ResNetTestBFloat16, resnet50_Linear_dedx_eager)
{
    linearDedx();
}

TEST_F_GC(SynGaudi2ResNetTestBFloat16, resnet50_Linear_dedx_eager_ASIC_CI)
{
    linearDedx();
}

TEST_F_GC(SynGaudi2ResNetTestBFloat16, resnet50_Linear_dedw_eager)
{
    linearDedw();
}

TEST_F_GC(SynGaudi2ResNetTestBFloat16, resnet50_Linear_dedw_eager_ASIC_CI)
{
    linearDedw();
}

TEST_F_GC(SynGaudi2ResNetTestBFloat16, resnet50_Linear_dedb_eager)
{
    linearDedb();
}

TEST_F_GC(SynGaudi2ResNetTestBFloat16, resnet50_Linear_dedb_eager_ASIC_CI)
{
    linearDedb();
}

TEST_F_GC(SynGaudi2ResNetTestBFloat16, resnet50_AvgPool2D_bwd_eager)
{
    avgPool2dBwd();
}

TEST_F_GC(SynGaudi2ResNetTestBFloat16, resnet50_AvgPool2D_bwd_eager_ASIC_CI)
{
    avgPool2dBwd();
}

TEST_F_GC(SynGaudi2ResNetTestBFloat16, resnet50_ReLU_bwd_eager)
{
    reluBwd();
}

TEST_F_GC(SynGaudi2ResNetTestBFloat16, resnet50_ReLU_bwd_eager_ASIC_CI)
{
    reluBwd();
}

TEST_F_GC(SynGaudi2ResNetTestBFloat16, resnet50_add_residual_bwd_eager)
{
    addResidualBwd();
}

TEST_F_GC(SynGaudi2ResNetTestBFloat16, resnet50_add_residual_bwd_eager_ASIC_CI)
{
    addResidualBwd();
}

TEST_F_GC(SynGaudi2ResNetTestBFloat16, resnet50_BatchNorm2D_bwd_eager)
{
    batchNorm2dBwd();
}

TEST_F_GC(SynGaudi2ResNetTestBFloat16, resnet50_BatchNorm2D_bwd_eager_ASIC_CI)
{
    batchNorm2dBwd();
}

TEST_F_GC(SynGaudi2ResNetTestBFloat16, resnet50_Conv2D_dedx_eager)
{
    conv2DDedx();
}

TEST_F_GC(SynGaudi2ResNetTestBFloat16, resnet50_Conv2D_dedx_eager_ASIC_CI)
{
    conv2DDedx();
}

TEST_F_GC(SynGaudi2ResNetTestBFloat16, resnet50_Conv2D_dedw_eager)
{
    conv2DDedw();
}

TEST_F_GC(SynGaudi2ResNetTestBFloat16, resnet50_Conv2D_dedw_eager_ASIC_CI)
{
    conv2DDedw();
}

TEST_F_GC(SynGaudi2ResNetTestBFloat16, resnet50_add_residual_fwd_eager)
{
    addResidualFwd();
}

TEST_F_GC(SynGaudi2ResNetTestBFloat16, resnet50_add_residual_fwd_eager_ASIC_CI)
{
    addResidualFwd();
}

TEST_F_GC(SynGaudi2ResNetTestBFloat16, resnet50_MaxPool2D_bwd_eager)
{
    maxPool2dBwd();
}

TEST_F_GC(SynGaudi2ResNetTestBFloat16, resnet50_MaxPool2D_bwd_eager_ASIC_CI)
{
    maxPool2dBwd();
}
