...
namespace
{
struct SynTrainingResNetTestFloat32 : SynTrainingResNetTest
{
};
} // anonymous namespace

TEST_F_GC(SynTrainingResNetTestFloat32, resnet50_Conv2D_fwd_ASIC_CI)
{
...
TEST_F_GC(SynTrainingResNetTestFloat32, resnet50_BatchNorm2D_fwd_ASIC_CI)
{
    const bool eagerMode = false;
...
TEST_F_GC(SynTrainingResNetTestFloat32, resnet50_ReLU_fwd_ASIC_CI)
{
    const bool eagerMode = false;
...
TEST_F_GC(SynTrainingResNetTestFloat32, resnet50_MaxPool2D_fwd_ASIC_CI)
{
    const bool eagerMode = false;
...
TEST_F_GC(SynTrainingResNetTestFloat32, resnet50_AvgPool2D_fwd_ASIC_CI)
{
    const bool eagerMode = false;
...
TEST_F_GC(SynTrainingResNetTestFloat32, resnet50_Linear_fwd_ASIC_CI)
{
    const bool eagerMode = false;
...
TEST_F_GC(SynTrainingResNetTestFloat32, resnet50_CrossEntropyLoss_log_softmax_ASIC_CI)
{
    const bool eagerMode = false;
...
TEST_F_GC(SynTrainingResNetTestFloat32, resnet50_CrossEntropyLoss_log_softmax_bwd_ASIC_CI)
{
    const bool eagerMode = false;
...
TEST_F_GC(SynTrainingResNetTestFloat32, resnet50_Linear_dedx_ASIC_CI)
{
    const bool eagerMode = false;
...
TEST_F_GC(SynTrainingResNetTestFloat32, resnet50_Linear_dedw_ASIC_CI)
{
    const bool eagerMode = false;
...
TEST_F_GC(SynTrainingResNetTestFloat32, resnet50_Linear_dedb_ASIC_CI)
{
    const bool eagerMode = false;
...
TEST_F_GC(SynTrainingResNetTestFloat32, resnet50_AvgPool2D_bwd_ASIC_CI)
{
    const bool eagerMode = false;
...
TEST_F_GC(SynTrainingResNetTestFloat32, resnet50_ReLU_bwd_ASIC_CI)
{
    const bool eagerMode = false;
...
TEST_F_GC(SynTrainingResNetTestFloat32, resnet50_add_residual_bwd_ASIC_CI)
{
    const bool eagerMode = false;
...
TEST_F_GC(SynTrainingResNetTestFloat32, resnet50_BatchNorm2D_bwd_ASIC_CI)
{
    const bool eagerMode = false;
...
TEST_F_GC(SynTrainingResNetTestFloat32, resnet50_Conv2D_dedx_ASIC_CI)
{
    const bool eagerMode = false;
...
TEST_F_GC(SynTrainingResNetTestFloat32, resnet50_Conv2D_dedw_ASIC_CI)
{
    const bool eagerMode = false;
...
TEST_F_GC(SynTrainingResNetTestFloat32, resnet50_add_residual_fwd_ASIC_CI)
{
    const bool eagerMode = false;
...
TEST_F_GC(SynTrainingResNetTestFloat32, resnet50_MaxPool2D_bwd_ASIC_CI)
{
    const bool eagerMode = false;
