...
TEST_F_GC(SynGaudi2ResNetTestEager, DISABLED_resnet50_cbr_bf16_eager_ASIC_CI)
{
    ...
    synTensor worker_0_conv1_output = createTensor(4U, syn_type_bf16, worker_0_conv1_output_sizes, false, "worker_0_conv1_output");
    ...
    synTensor worker_0_bn1_output = createTensor(4U, syn_type_bf16, worker_0_bn1_output_sizes, false, "worker_0_bn1_output");
