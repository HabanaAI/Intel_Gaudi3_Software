...
class SynGaudiDLRMTestFloat32 : public SynGaudiAutoGenTest
{
public:
    SynGaudiDLRMTestFloat32() { setSupportedDevices({synDeviceGaudi}); }
};

TEST_F_GC(SynGaudiDLRMTestFloat32, dlrm_Linear_fwd)
{
    ...
    /*************
     * bot_l_0_linear node
     * inputs: [X_int(128, 1, 1, 13)(dtype=float32), bot_l_0_linear_weight(1, 1, 13, 512)(dtype=float32), bot_l_0_linear_bias[512](dtype=float32)]
     * output: [bot_l_0_linear_output(128, 1, 1, 512)(dtype=float32)]
     *************/
    ...
    // create X_int tensor
    pManagedTensor X_int = ManagedTensor::createManagedTensor("X_int", {128, 1, 1, 13}, syn_type_single, true, this);
    synLaunchTensorInfo X_int_tr_info = {"X_int", X_int->getDramAddress()};

    // create bot_l_0_linear_weight tensor
    pManagedTensor bot_l_0_linear_weight = ManagedTensor::createManagedTensor("bot_l_0_linear_weight", {1, 1, 13, 512}, syn_type_single, true, this);
    ...
    pManagedTensor bot_l_0_linear_bias = ManagedTensor::createManagedTensor("bot_l_0_linear_bias", {512,}, syn_type_single, true, this);
    ...
    pManagedTensor bot_l_0_linear_output = ManagedTensor::createManagedTensor("bot_l_0_linear_output", {128, 1, 1, 512}, syn_type_single, true, this);
    ...
    // generate graph
    SetTestFileName("dlrm_Linear_fwd_float32");
    ...
    {
        float* ref_arr = new float[bot_l_0_linear_output->getNumberOfElements()];
        void* data = nullptr;
...
TEST_F_GC(SynGaudiDLRMTestFloat32, dlrm_ReLU_fwd)
{
    uint32_t deviceId = _getDeviceId();
    synGraphHandle graphHandle;
    GCFG_CHECK_SECTION_OVERLAP.setValue(false);
    ...
    /*************
     * bot_l_0_relu node
     * inputs: [bot_l_0_linear_output(128, 1, 1, 512)(dtype=float32)]
     * output: [bot_l_0_relu_output(128, 1, 1, 512)(dtype=float32)]
     *************/
    ...
    pManagedTensor bot_l_0_relu_output = ManagedTensor::createManagedTensor("bot_l_0_relu_output", {128, 1, 1, 512}, syn_type_single, true, this);
    synLaunchTensorInfo bot_l_0_relu_output_tr_info = {"bot_l_0_relu_output", bot_l_0_relu_output->getDramAddress()};
    ManagedNode bot_l_0_relu({bot_l_0_linear_output}, {bot_l_0_relu_output}, "bot_l_0_relu", "relu_fwd_f32", graphHandle);
    bot_l_0_relu.createNode();


    // generate graph
    SetTestFileName("dlrm_ReLU_fwd_float32");
    LaunchInfo launchInfo = compileAllocateAndLoadGraph(graphHandle);
    TensorInfoList graph_inputs;
    TensorInfoList graph_outputs;
    ...
    {
        float* ref_arr = new float[bot_l_0_relu_output->getNumberOfElements()];
        void* data = nullptr;
...
TEST_F_GC(SynGaudiDLRMTestFloat32, DISABLED_dlrm_EmbeddingBag_fwd) // disabled since guid was removed
{
    uint32_t deviceId = _getDeviceId();
    synGraphHandle graphHandle;
    GCFG_CHECK_SECTION_OVERLAP.setValue(false);
    ...
    /*************
     * emb_0_embbag node
     * inputs: [emb_0_embbag_weight[1460, 32](dtype=float32), lS_indices_0[128](dtype=int32), lS_offset_0[128](dtype=int32)]
     * output: [emb_0_embbag_output(128, 32)(dtype=float32)]
     *************/
    ...
    pManagedTensor emb_0_embbag_weight = ManagedTensor::createManagedTensor("emb_0_embbag_weight", {1460, 32}, syn_type_single, true, this);
    ...
    pManagedTensor emb_0_embbag_output = ManagedTensor::createManagedTensor("emb_0_embbag_output", {128, 32}, syn_type_single, true, this);
    synLaunchTensorInfo emb_0_embbag_output_tr_info = {"emb_0_embbag_output", emb_0_embbag_output->getDramAddress()};
    ManagedNodeWithParams<ns_EmbeddingBagWithSgdKernel::Params> emb_0_embbag({emb_0_embbag_weight, lS_indices_0, lS_offset_0}, {emb_0_embbag_output}, "emb_0_embbag", "embedding_bag_sgd_fwd_f32", graphHandle, emb_0_embbag_kernel_params);
    emb_0_embbag.createNode();


    // generate graph
    SetTestFileName("dlrm_EmbeddingBag_fwd_float32");
    LaunchInfo launchInfo = compileAllocateAndLoadGraph(graphHandle);
    TensorInfoList graph_inputs;
    TensorInfoList graph_outputs;
    ...
    {
        float* ref_arr = new float[emb_0_embbag_output->getNumberOfElements()];
        void* data = nullptr;
...
TEST_F_GC(SynGaudiDLRMTestFloat32, dlrm_Concat_fwd)
{
    uint32_t deviceId = _getDeviceId();
    synGraphHandle graphHandle;
    GCFG_CHECK_SECTION_OVERLAP.setValue(false);
     ...
     * inputs: [bot_l_4_relu_output[128, 32](dtype=float32), emb_0_embbag_output[128, 32](dtype=float32), emb_1_embbag_output[128, 32](dtype=float32), emb_2_embbag_output[128, 32](dtype=float32), emb_3_embbag_output[128, 32](dtype=float32), emb_4_embbag_output[128, 32](dtype=float32), emb_5_embbag_output[128, 32](dtype=float32), emb_6_embbag_output[128, 32](dtype=float32), emb_7_embbag_output[128, 32](dtype=float32), emb_8_embbag_output[128, 32](dtype=float32), emb_9_embbag_output[128, 32](dtype=float32), emb_10_embbag_output[128, 32](dtype=float32), emb_11_embbag_output[128, 32](dtype=float32), emb_12_embbag_output[128, 32](dtype=float32), emb_13_embbag_output[128, 32](dtype=float32), emb_14_embbag_output[128, 32](dtype=float32), emb_15_embbag_output[128, 32](dtype=float32), emb_16_embbag_output[128, 32](dtype=float32), emb_17_embbag_output[128, 32](dtype=float32), emb_18_embbag_output[128, 32](dtype=float32), emb_19_embbag_output[128, 32](dtype=float32), emb_20_embbag_output[128, 32](dtype=float32), emb_21_embbag_output[128, 32](dtype=float32), emb_22_embbag_output[128, 32](dtype=float32), emb_23_embbag_output[128, 32](dtype=float32), emb_24_embbag_output[128, 32](dtype=float32), emb_25_embbag_output[128, 32](dtype=float32)]
     * output: [concat_interact0_output(128, 864)(dtype=float32)]
     *************/

    // create bot_l_4_relu_output tensor
    pManagedTensor bot_l_4_relu_output = ManagedTensor::createManagedTensor("bot_l_4_relu_output", {128, 32}, syn_type_single, true, this);
    ...
    pManagedTensor emb_1_embbag_output = ManagedTensor::createManagedTensor("emb_1_embbag_output", {128, 32}, syn_type_single, true, this);
    ...
    pManagedTensor emb_2_embbag_output = ManagedTensor::createManagedTensor("emb_2_embbag_output", {128, 32}, syn_type_single, true, this);
    ...
    pManagedTensor emb_3_embbag_output = ManagedTensor::createManagedTensor("emb_3_embbag_output", {128, 32}, syn_type_single, true, this);
    ...
    pManagedTensor emb_4_embbag_output = ManagedTensor::createManagedTensor("emb_4_embbag_output", {128, 32}, syn_type_single, true, this);
    ...
    pManagedTensor emb_5_embbag_output = ManagedTensor::createManagedTensor("emb_5_embbag_output", {128, 32}, syn_type_single, true, this);
    ...
    pManagedTensor emb_6_embbag_output = ManagedTensor::createManagedTensor("emb_6_embbag_output", {128, 32}, syn_type_single, true, this);
    ...
    pManagedTensor emb_7_embbag_output = ManagedTensor::createManagedTensor("emb_7_embbag_output", {128, 32}, syn_type_single, true, this);
    ...
    pManagedTensor emb_8_embbag_output = ManagedTensor::createManagedTensor("emb_8_embbag_output", {128, 32}, syn_type_single, true, this);
    ...
    pManagedTensor emb_9_embbag_output = ManagedTensor::createManagedTensor("emb_9_embbag_output", {128, 32}, syn_type_single, true, this);
    ...
    pManagedTensor emb_10_embbag_output = ManagedTensor::createManagedTensor("emb_10_embbag_output", {128, 32}, syn_type_single, true, this);
    ...
    pManagedTensor emb_11_embbag_output = ManagedTensor::createManagedTensor("emb_11_embbag_output", {128, 32}, syn_type_single, true, this);
    ...
    pManagedTensor emb_12_embbag_output = ManagedTensor::createManagedTensor("emb_12_embbag_output", {128, 32}, syn_type_single, true, this);
    ...
    pManagedTensor emb_13_embbag_output = ManagedTensor::createManagedTensor("emb_13_embbag_output", {128, 32}, syn_type_single, true, this);
    ...
    pManagedTensor emb_14_embbag_output = ManagedTensor::createManagedTensor("emb_14_embbag_output", {128, 32}, syn_type_single, true, this);
    ...
    pManagedTensor emb_15_embbag_output = ManagedTensor::createManagedTensor("emb_15_embbag_output", {128, 32}, syn_type_single, true, this);
    ...
    pManagedTensor emb_16_embbag_output = ManagedTensor::createManagedTensor("emb_16_embbag_output", {128, 32}, syn_type_single, true, this);
    ...
    pManagedTensor emb_17_embbag_output = ManagedTensor::createManagedTensor("emb_17_embbag_output", {128, 32}, syn_type_single, true, this);
    ...
    pManagedTensor emb_18_embbag_output = ManagedTensor::createManagedTensor("emb_18_embbag_output", {128, 32}, syn_type_single, true, this);
    ...
    pManagedTensor emb_19_embbag_output = ManagedTensor::createManagedTensor("emb_19_embbag_output", {128, 32}, syn_type_single, true, this);
    ...
    pManagedTensor emb_20_embbag_output = ManagedTensor::createManagedTensor("emb_20_embbag_output", {128, 32}, syn_type_single, true, this);
    ...
    pManagedTensor emb_21_embbag_output = ManagedTensor::createManagedTensor("emb_21_embbag_output", {128, 32}, syn_type_single, true, this);
    ...
    pManagedTensor emb_22_embbag_output = ManagedTensor::createManagedTensor("emb_22_embbag_output", {128, 32}, syn_type_single, true, this);
    ...
    pManagedTensor emb_23_embbag_output = ManagedTensor::createManagedTensor("emb_23_embbag_output", {128, 32}, syn_type_single, true, this);
    ...
    pManagedTensor emb_24_embbag_output = ManagedTensor::createManagedTensor("emb_24_embbag_output", {128, 32}, syn_type_single, true, this);
    ...
    pManagedTensor emb_25_embbag_output = ManagedTensor::createManagedTensor("emb_25_embbag_output", {128, 32}, syn_type_single, true, this);
    ...
    pManagedTensor concat_interact0_output = ManagedTensor::createManagedTensor("concat_interact0_output", {128, 864}, syn_type_single, true, this);
    ...
    // generate graph
    SetTestFileName("dlrm_Concat_fwd_float32");
    LaunchInfo launchInfo = compileAllocateAndLoadGraph(graphHandle);
    TensorInfoList graph_inputs;
    TensorInfoList graph_outputs;
    ...
    {
        float* ref_arr = new float[concat_interact0_output->getNumberOfElements()];
        void* data = nullptr;
...
TEST_F_GC(SynGaudiDLRMTestFloat32, dlrm_Reshape_fwd)
{
    uint32_t deviceId = _getDeviceId();
    synGraphHandle graphHandle;
    GCFG_CHECK_SECTION_OVERLAP.setValue(false);
     ...
     * inputs: [concat_interact0_output[128, 864](dtype=float32)]
     * output: [reshape_bmm_output(128, 27, 32)(dtype=float32)]
     *************/
    ...
    pManagedTensor reshape_bmm_output = ManagedTensor::createManagedTensor("reshape_bmm_output", {128, 27, 32}, syn_type_single, true, this);
    ...
    // generate graph
    SetTestFileName("dlrm_Reshape_fwd_float32");
    LaunchInfo launchInfo = compileAllocateAndLoadGraph(graphHandle);
    TensorInfoList graph_inputs;
    TensorInfoList graph_outputs;
    ...
    {
        float* ref_arr = new float[reshape_bmm_output->getNumberOfElements()];
        void* data = nullptr;
...
TEST_F_GC(SynGaudiDLRMTestFloat32, dlrm_BMM_fwd)
{
    uint32_t deviceId = _getDeviceId();
    synGraphHandle graphHandle;
    GCFG_CHECK_SECTION_OVERLAP.setValue(false);
    ...
    /*************
     * bmm_interact node
     * inputs: [reshape_bmm_output[128, 27, 32](dtype=float32), reshape_bmm_output[128, 27, 32](dtype=float32)]
     * output: [bmm_interact_output(128, 27, 27)(dtype=float32)]
     *************/
    ...
    pManagedTensor bmm_interact_output = ManagedTensor::createManagedTensor("bmm_interact_output", {128, 27, 27}, syn_type_single, true, this);
    ...
    // generate graph
    SetTestFileName("dlrm_BMM_fwd_float32");
    LaunchInfo launchInfo = compileAllocateAndLoadGraph(graphHandle);
    TensorInfoList graph_inputs;
    TensorInfoList graph_outputs;
    ...
    {
        float* ref_arr = new float[bmm_interact_output->getNumberOfElements()];
        void* data = nullptr;
...
TEST_F_GC(SynGaudiDLRMTestFloat32, dlrm_gather_fwd)
{
    uint32_t deviceId = _getDeviceId();
    synGraphHandle graphHandle;
    GCFG_CHECK_SECTION_OVERLAP.setValue(false);
     ...
     * inputs: [reshape_tril_output[128, 729](dtype=float32), tril_indices[351](dtype=int32)]
     * output: [tril_indices_output(128, 351)(dtype=float32)]
     *************/
    ...
    pManagedTensor reshape_tril_output = ManagedTensor::createManagedTensor("reshape_tril_output", {128, 729}, syn_type_single, true, this);
    ...
    pManagedTensor tril_indices_output = ManagedTensor::createManagedTensor("tril_indices_output", {128, 351}, syn_type_single, true, this);
    synLaunchTensorInfo tril_indices_output_tr_info = {"tril_indices_output", tril_indices_output->getDramAddress()};
    ManagedNodeWithParams<ns_ScatterKernel::Params> tril_indices_fwd({reshape_tril_output, tril_indices}, {tril_indices_output}, "tril_indices_fwd", "gather_fwd_f32", graphHandle, tril_indices_fwd_kernel_params);
    tril_indices_fwd.createNode();


    // generate graph
    SetTestFileName("dlrm_gather_fwd_float32");
    LaunchInfo launchInfo = compileAllocateAndLoadGraph(graphHandle);
    TensorInfoList graph_inputs;
    TensorInfoList graph_outputs;
    ...
    {
        float* ref_arr = new float[tril_indices_output->getNumberOfElements()];
        void* data = nullptr;
...
TEST_F_GC(SynGaudiDLRMTestFloat32, dlrm_BinaryCrossEntropyLoss_fwd)
{
    uint32_t deviceId = _getDeviceId();
    synGraphHandle graphHandle;
    GCFG_CHECK_SECTION_OVERLAP.setValue(false);
     ...
     * inputs: [top_l_10_linear_output[1, 128](dtype=float32), target[1, 128](dtype=float32)]
     * output: [binary_cross_entropy_loss_output(1,)(dtype=float32), binary_cross_entropy_loss_saved_sigmoid(1, 128)(dtype=float32)]
     *************/
    ...
    pManagedTensor top_l_10_linear_output = ManagedTensor::createManagedTensor("top_l_10_linear_output", {1, 128}, syn_type_single, true, this);
    synLaunchTensorInfo top_l_10_linear_output_tr_info = {"top_l_10_linear_output",
                                                          top_l_10_linear_output->getDramAddress()};

    // create target tensor
    pManagedTensor target = ManagedTensor::createManagedTensor("target", {1, 128}, syn_type_single, true, this);
    synLaunchTensorInfo target_tr_info = {"target", target->getDramAddress()};

    // create binary_cross_entropy_loss_output tensor
    pManagedTensor binary_cross_entropy_loss_output = ManagedTensor::createManagedTensor("binary_cross_entropy_loss_output", {1,}, syn_type_single, true, this);
    ...
    pManagedTensor binary_cross_entropy_loss_saved_sigmoid = ManagedTensor::createManagedTensor("binary_cross_entropy_loss_saved_sigmoid", {1, 128}, syn_type_single, true, this);
    ...
    ManagedNodeWithParams<ns_BinaryCrossEntropy::Params> binary_cross_entropy_loss_fwd({top_l_10_linear_output, target}, {binary_cross_entropy_loss_output, binary_cross_entropy_loss_saved_sigmoid}, "binary_cross_entropy_loss_fwd", "binary_cross_entropy_fwd_f32", graphHandle, binary_cross_entropy_loss_fwd_kernel_params);
    binary_cross_entropy_loss_fwd.createNode();


    // generate graph
    SetTestFileName("dlrm_BinaryCrossEntropyLoss_fwd_float32");
    LaunchInfo launchInfo = compileAllocateAndLoadGraph(graphHandle);
    TensorInfoList graph_inputs;
    TensorInfoList graph_outputs;
    ...
    {
        float* ref_arr = new float[binary_cross_entropy_loss_output->getNumberOfElements()];
        void* data = nullptr;
    ...
    {
        float* ref_arr = new float[binary_cross_entropy_loss_saved_sigmoid->getNumberOfElements()];
        void* data = nullptr;
...
TEST_F_GC(SynGaudiDLRMTestFloat32, dlrm_BinaryCrossEntropyLoss_bwd)
{
    uint32_t deviceId = _getDeviceId();
    synGraphHandle graphHandle;
    GCFG_CHECK_SECTION_OVERLAP.setValue(false);
     ...
     * inputs: [top_l_10_linear_output[1, 128](dtype=float32), target[1, 128](dtype=float32)]
     * output: [binary_cross_entropy_loss_grad_input(1, 128)(dtype=float32)]
     *************/
    ...
    pManagedTensor binary_cross_entropy_loss_grad_input = ManagedTensor::createManagedTensor("binary_cross_entropy_loss_grad_input", {1, 128}, syn_type_single, true, this);
    ...
    ManagedNodeWithParams<ns_BinaryCrossEntropy::Params> binary_cross_entropy_loss_bwd({top_l_10_linear_output, target}, {binary_cross_entropy_loss_grad_input}, "binary_cross_entropy_loss_bwd", "binary_cross_entropy_bwd_f32", graphHandle, binary_cross_entropy_loss_bwd_kernel_params);
    binary_cross_entropy_loss_bwd.createNode();


    // generate graph
    SetTestFileName("dlrm_BinaryCrossEntropyLoss_bwd_float32");
    LaunchInfo launchInfo = compileAllocateAndLoadGraph(graphHandle);
    TensorInfoList graph_inputs;
    TensorInfoList graph_outputs;
    ...
    {
        float* ref_arr = new float[binary_cross_entropy_loss_grad_input->getNumberOfElements()];
        void* data = nullptr;
...
TEST_F_GC(SynGaudiDLRMTestFloat32, dlrm_Linear_dedx)
{
    uint32_t deviceId = _getDeviceId();
    synGraphHandle graphHandle;
    GCFG_CHECK_SECTION_OVERLAP.setValue(false);
     ...
     * inputs: [binary_cross_entropy_loss_grad_input(128, 1, 1, 1)(dtype=float32), top_l_10_linear_weight(1, 1, 1024, 1)(dtype=float32)]
     * output: [top_l_10_linear_grad_input(128, 1, 1, 1024)(dtype=float32)]
     *************/
    ...
    // create binary_cross_entropy_loss_grad_input tensor
    pManagedTensor binary_cross_entropy_loss_grad_input = ManagedTensor::createManagedTensor("binary_cross_entropy_loss_grad_input", {128, 1, 1, 1}, syn_type_single, true, this);
    synLaunchTensorInfo binary_cross_entropy_loss_grad_input_tr_info = {
        "binary_cross_entropy_loss_grad_input",
        binary_cross_entropy_loss_grad_input->getDramAddress()};

    // create top_l_10_linear_weight tensor
    pManagedTensor top_l_10_linear_weight = ManagedTensor::createManagedTensor("top_l_10_linear_weight", {1, 1, 1024, 1}, syn_type_single, true, this);
    ...
    pManagedTensor top_l_10_linear_grad_input = ManagedTensor::createManagedTensor("top_l_10_linear_grad_input", {128, 1, 1, 1024}, syn_type_single, true, this);
    ...
    // generate graph
    SetTestFileName("dlrm_Linear_dedx_float32");
    LaunchInfo launchInfo = compileAllocateAndLoadGraph(graphHandle);
    TensorInfoList graph_inputs;
    TensorInfoList graph_outputs;
    ...
    {
        float* ref_arr = new float[top_l_10_linear_grad_input->getNumberOfElements()];
        void* data = nullptr;
...
TEST_F_GC(SynGaudiDLRMTestFloat32, dlrm_Linear_dedw)
{
    uint32_t deviceId = _getDeviceId();
    synGraphHandle graphHandle;
    GCFG_CHECK_SECTION_OVERLAP.setValue(false);
     ...
     * inputs: [binary_cross_entropy_loss_grad_input(128, 1, 1, 1)(dtype=float32), top_l_8_relu_output(128, 1, 1, 1024)(dtype=float32)]
    ...
    pManagedTensor top_l_8_relu_output = ManagedTensor::createManagedTensor("top_l_8_relu_output", {128, 1, 1, 1024}, syn_type_single, true, this);
    ...
    // generate graph
    SetTestFileName("dlrm_Linear_dedw_float32");
    LaunchInfo launchInfo = compileAllocateAndLoadGraph(graphHandle);
    TensorInfoList graph_inputs;
    TensorInfoList graph_outputs;
...
TEST_F_GC(SynGaudiDLRMTestFloat32, dlrm_Linear_dedb)
{
    uint32_t deviceId = _getDeviceId();
    synGraphHandle graphHandle;
    GCFG_CHECK_SECTION_OVERLAP.setValue(false);
     ...
     * inputs: [binary_cross_entropy_loss_grad_input[128, 1](dtype=float32)]
    ...
    // create binary_cross_entropy_loss_grad_input tensor
    pManagedTensor binary_cross_entropy_loss_grad_input = ManagedTensor::createManagedTensor("binary_cross_entropy_loss_grad_input", {128, 1}, syn_type_single, true, this);
    synLaunchTensorInfo binary_cross_entropy_loss_grad_input_tr_info = {
        "binary_cross_entropy_loss_grad_input",
        binary_cross_entropy_loss_grad_input->getDramAddress()};
    ...
    ManagedNodeWithParams<ns_Reduction::Params> top_l_10_linear_dedb({binary_cross_entropy_loss_grad_input}, {top_l_10_linear_bias_grad}, "top_l_10_linear_dedb", "reduce_sum_fwd_f32", graphHandle, top_l_10_linear_dedb_kernel_params);
    top_l_10_linear_dedb.createNode();


    // generate graph
    SetTestFileName("dlrm_Linear_dedb_float32");
    LaunchInfo launchInfo = compileAllocateAndLoadGraph(graphHandle);
    TensorInfoList graph_inputs;
    TensorInfoList graph_outputs;
...
TEST_F_GC(SynGaudiDLRMTestFloat32, dlrm_ReLU_bwd)
{
    uint32_t deviceId = _getDeviceId();
    synGraphHandle graphHandle;
    GCFG_CHECK_SECTION_OVERLAP.setValue(false);
     ...
     * inputs: [top_l_10_linear_grad_input(128, 1, 1, 1024)(dtype=float32), top_l_8_relu_output(128, 1, 1, 1024)(dtype=float32)]
     * output: [top_l_8_relu_grad_input(128, 1, 1, 1024)(dtype=float32)]
     *************/
    ...
    pManagedTensor top_l_8_relu_grad_input = ManagedTensor::createManagedTensor("top_l_8_relu_grad_input", {128, 1, 1, 1024}, syn_type_single, true, this);
    synLaunchTensorInfo top_l_8_relu_grad_input_tr_info = {"top_l_8_relu_grad_input",
                                                           top_l_8_relu_grad_input->getDramAddress()};
    ManagedNode top_l_8_relu_bwd({top_l_10_linear_grad_input, top_l_8_relu_output}, {top_l_8_relu_grad_input}, "top_l_8_relu_bwd", "relu_bwd_f32", graphHandle);
    top_l_8_relu_bwd.createNode();


    // generate graph
    SetTestFileName("dlrm_ReLU_bwd_float32");
    LaunchInfo launchInfo = compileAllocateAndLoadGraph(graphHandle);
    TensorInfoList graph_inputs;
    TensorInfoList graph_outputs;
    ...
    {
        float* ref_arr = new float[top_l_8_relu_grad_input->getNumberOfElements()];
        void* data = nullptr;
...
TEST_F_GC(SynGaudiDLRMTestFloat32, dlrm_Concat_dedx)
{
    uint32_t deviceId = _getDeviceId();
    synGraphHandle graphHandle;
    GCFG_CHECK_SECTION_OVERLAP.setValue(false);
     ...
     * inputs: [top_l_0_linear_grad_input[128, 383](dtype=float32)]
     * output: [concat_interact1_grad_input0(128, 32)(dtype=float32), concat_interact1_grad_input1(128, 351)(dtype=float32)]
     *************/
    unsigned concat_interact1_dedx_kernel_params;
    concat_interact1_dedx_kernel_params = 0;

    // create top_l_0_linear_grad_input tensor
    pManagedTensor top_l_0_linear_grad_input = ManagedTensor::createManagedTensor("top_l_0_linear_grad_input", {128, 383}, syn_type_single, true, this);
    ...
    pManagedTensor concat_interact1_grad_input0 = ManagedTensor::createManagedTensor("concat_interact1_grad_input0", {128, 32}, syn_type_single, true, this);
    ...
    pManagedTensor concat_interact1_grad_input1 = ManagedTensor::createManagedTensor("concat_interact1_grad_input1", {128, 351}, syn_type_single, true, this);
    ...
    // generate graph
    SetTestFileName("dlrm_Concat_dedx_float32");
    LaunchInfo launchInfo = compileAllocateAndLoadGraph(graphHandle);
    TensorInfoList graph_inputs;
    TensorInfoList graph_outputs;
    ...
    {
        float* ref_arr = new float[concat_interact1_grad_input0->getNumberOfElements()];
        void* data = nullptr;
    ...
    {
        float* ref_arr = new float[concat_interact1_grad_input1->getNumberOfElements()];
        void* data = nullptr;
...
TEST_F_GC(SynGaudiDLRMTestFloat32, dlrm_gather_dedx)
{
    uint32_t deviceId = _getDeviceId();
    synGraphHandle graphHandle;
    GCFG_CHECK_SECTION_OVERLAP.setValue(false);
     ...
     * inputs: [tril_grad_buffer[128, 729](dtype=float32), tril_indices_broadcast[128, 351](dtype=int32), concat_interact1_grad_input1[128, 351](dtype=float32)]
     * output: [tril_indices_grad_input(128, 729)(dtype=float32)]
     *************/
    ...
    pManagedTensor tril_grad_buffer = ManagedTensor::createManagedTensor("tril_grad_buffer", {128, 729}, syn_type_single, true, this);
    ...
    pManagedTensor tril_indices_grad_input = ManagedTensor::createManagedTensor("tril_indices_grad_input", {128, 729}, syn_type_single, true, this);
    synLaunchTensorInfo                             tril_indices_grad_input_tr_info = {"tril_indices_grad_input",
                                                           tril_indices_grad_input->getDramAddress()};
    ManagedNodeWithParams<ns_ScatterKernel::Params> tril_indices_dedx({tril_grad_buffer, tril_indices_broadcast, concat_interact1_grad_input1}, {tril_indices_grad_input}, "tril_indices_dedx", "gather_bwd_f32", graphHandle, tril_indices_dedx_kernel_params);
    tril_indices_dedx.createNode();


    // generate graph
    SetTestFileName("dlrm_gather_dedx_float32");
    LaunchInfo launchInfo = compileAllocateAndLoadGraph(graphHandle);
    TensorInfoList graph_inputs;
    TensorInfoList graph_outputs;
    ...
    {
        float* ref_arr = new float[tril_indices_grad_input->getNumberOfElements()];
        void* data = nullptr;
...
TEST_F_GC(SynGaudiDLRMTestFloat32, dlrm_Reshape_dedx)
{
    uint32_t deviceId = _getDeviceId();
    synGraphHandle graphHandle;
    GCFG_CHECK_SECTION_OVERLAP.setValue(false);
     ...
     * inputs: [tril_indices_grad_input[128, 729](dtype=float32)]
     * output: [reshape_tril_grad_input(128, 27, 27)(dtype=float32)]
     *************/
    ...
    pManagedTensor reshape_tril_grad_input = ManagedTensor::createManagedTensor("reshape_tril_grad_input", {128, 27, 27}, syn_type_single, true, this);
    ...
    // generate graph
    SetTestFileName("dlrm_Reshape_dedx_float32");
    LaunchInfo launchInfo = compileAllocateAndLoadGraph(graphHandle);
    TensorInfoList graph_inputs;
    TensorInfoList graph_outputs;
    ...
    {
        float* ref_arr = new float[reshape_tril_grad_input->getNumberOfElements()];
        void* data = nullptr;
...
TEST_F_GC(SynGaudiDLRMTestFloat32, dlrm_BMM_dedx)
{
    uint32_t deviceId = _getDeviceId();
    synGraphHandle graphHandle;
    GCFG_CHECK_SECTION_OVERLAP.setValue(false);
     ...
     * inputs: [reshape_tril_grad_input[128, 27, 27](dtype=float32), reshape_bmm_output[128, 27, 32](dtype=float32)]
    ...
    pManagedTensor reshape_tril_grad_input =
        ManagedTensor::createManagedTensor("reshape_tril_grad_input", {128, 27, 27}, syn_type_single, true, this);
    synLaunchTensorInfo reshape_tril_grad_input_tr_info = {"reshape_tril_grad_input",
                                                           reshape_tril_grad_input->getDramAddress()};

    // create reshape_bmm_output tensor
    pManagedTensor reshape_bmm_output =
        ManagedTensor::createManagedTensor("reshape_bmm_output", {128, 32, 27}, syn_type_single, true, this);
    synLaunchTensorInfo reshape_bmm_output_tr_info = {"reshape_bmm_output", reshape_bmm_output->getDramAddress()};
    ...
    // generate graph
    SetTestFileName("dlrm_BMM_dedx_float32");
    LaunchInfo launchInfo = compileAllocateAndLoadGraph(graphHandle);
    TensorInfoList graph_inputs;
    TensorInfoList graph_outputs;
...
TEST_F_GC(SynGaudiDLRMTestFloat32, dlrm_BMM_dedw)
{
    uint32_t deviceId = _getDeviceId();
    synGraphHandle graphHandle;
    GCFG_CHECK_SECTION_OVERLAP.setValue(false);
    ...
    // generate graph
    SetTestFileName("dlrm_BMM_dedw_float32");
    LaunchInfo launchInfo = compileAllocateAndLoadGraph(graphHandle);
    TensorInfoList graph_inputs;
    TensorInfoList graph_outputs;
...
TEST_F_GC(SynGaudiDLRMTestFloat32, dlrm_transpose)
{
    uint32_t deviceId = _getDeviceId();
    synGraphHandle graphHandle;
    GCFG_CHECK_SECTION_OVERLAP.setValue(false);
    ...
    // generate graph
    SetTestFileName("dlrm_transpose_float32");
    LaunchInfo launchInfo = compileAllocateAndLoadGraph(graphHandle);
    TensorInfoList graph_inputs;
    TensorInfoList graph_outputs;
...
TEST_F_GC(SynGaudiDLRMTestFloat32, dlrm_AddResidual_fwd)
{
    uint32_t deviceId = _getDeviceId();
    synGraphHandle graphHandle;
    GCFG_CHECK_SECTION_OVERLAP.setValue(false);
     ...
     * inputs: [concat_interact1_grad_input0[128, 32](dtype=float32), concat_interact0_grad_input0[128, 32](dtype=float32)]
     * output: [add_grads_concat_output(128, 32)(dtype=float32)]
     *************/
    ...
    pManagedTensor concat_interact0_grad_input0 = ManagedTensor::createManagedTensor("concat_interact0_grad_input0", {128, 32}, syn_type_single, true, this);
    synLaunchTensorInfo concat_interact0_grad_input0_tr_info = {"concat_interact0_grad_input0",
                                                                concat_interact0_grad_input0->getDramAddress()};

    // create add_grads_concat_output tensor
    pManagedTensor add_grads_concat_output = ManagedTensor::createManagedTensor("add_grads_concat_output", {128, 32}, syn_type_single, true, this);
    synLaunchTensorInfo add_grads_concat_output_tr_info = {"add_grads_concat_output",
                                                           add_grads_concat_output->getDramAddress()};
    ManagedNode add_grads_concat({concat_interact1_grad_input0, concat_interact0_grad_input0}, {add_grads_concat_output}, "add_grads_concat", "add_fwd_f32", graphHandle);
    add_grads_concat.createNode();


    // generate graph
    SetTestFileName("dlrm_AddResidual_fwd_float32");
    LaunchInfo launchInfo = compileAllocateAndLoadGraph(graphHandle);
    TensorInfoList graph_inputs;
    TensorInfoList graph_outputs;
    ...
    // init tensor concat_interact1_grad_input0 from file
    {
        void* data = nullptr;
        status = synHostMalloc(deviceId, concat_interact1_grad_input0->getTotalSizeInBytes(), 0, &data);
        ASSERT_TRUE(status == synSuccess && "synHostMalloc failed");
        float* typed_data = static_cast<float*>(data);
        bool file_res = read_file("/software/dlrm_traininig/sw_extracted_tensors/concat_interact1_grad_input0", typed_data, concat_interact1_grad_input0->getNumberOfElements());
        ASSERT_TRUE(file_res);
        downloadTensorData(data, concat_interact1_grad_input0->getDramAddress(), concat_interact1_grad_input0->getTotalSizeInBytes());
        status = synHostFree(deviceId, data, 0);
        ASSERT_TRUE(status == synSuccess && "synHostFree failed");
    }
    graph_inputs.push_back(concat_interact1_grad_input0_tr_info);

    // init tensor concat_interact0_grad_input0 from file
    {
        void* data = nullptr;
        status = synHostMalloc(deviceId, concat_interact0_grad_input0->getTotalSizeInBytes(), 0, &data);
        ASSERT_TRUE(status == synSuccess && "synHostMalloc failed");
        float* typed_data = static_cast<float*>(data);
        bool file_res = read_file("/software/dlrm_traininig/sw_extracted_tensors/concat_interact0_grad_input0", typed_data, concat_interact0_grad_input0->getNumberOfElements());
        ASSERT_TRUE(file_res);
        downloadTensorData(data, concat_interact0_grad_input0->getDramAddress(), concat_interact0_grad_input0->getTotalSizeInBytes());
        status = synHostFree(deviceId, data, 0);
        ASSERT_TRUE(status == synSuccess && "synHostFree failed");
    }
    graph_inputs.push_back(concat_interact0_grad_input0_tr_info);

    // List outputs
    graph_outputs.push_back(add_grads_concat_output_tr_info);

    // Go! Go! Go!
    executeTraining(launchInfo, graph_inputs, graph_outputs);

    // Check data against files
    // data check for tensor add_grads_concat_output from file
    {
        float* ref_arr = new float[add_grads_concat_output->getNumberOfElements()];
        void* data = nullptr;
        status = synHostMalloc(deviceId, add_grads_concat_output->getTotalSizeInBytes(), 0, &data);
        ASSERT_TRUE(status == synSuccess && "synHostMalloc failed");
        float* typed_data = static_cast<float*>(data);
        bool file_res = read_file("/software/dlrm_traininig/sw_extracted_tensors/add_grads_concat_output", ref_arr, add_grads_concat_output->getNumberOfElements());
        (void)file_res;
        if (file_res)
        {
            uploadTensorData(add_grads_concat_output->getDramAddress(), data, add_grads_concat_output->getTotalSizeInBytes());
            LOG_WARN(SYN_TEST, "validating: add_grads_concat_output");
            validateResult(ref_arr, typed_data, add_grads_concat_output->getNumberOfElements());
        } else {
            LOG_WARN(SYN_TEST, "Result compare skipped due to missing file: add_grads_concat_output");
        }
        delete[] ref_arr;
    }
...
TEST_F_GC(SynGaudiDLRMTestFloat32, DISABLED_dlrm_EmbeddingBag_dedw) // disabled since guid was removed
{
    uint32_t deviceId = _getDeviceId();
    synGraphHandle graphHandle;
    GCFG_CHECK_SECTION_OVERLAP.setValue(false);
    ...
    pManagedTensor emb_0_embbag_dedw_weight_output = ManagedTensor::createManagedTensor("emb_0_embbag_dedw_weight_output", {1460, 32}, syn_type_single, true, this);
    ...
    ManagedNodeWithParams<ns_EmbeddingBagWithSgdKernel::Params> emb_0_embbag_dedw_EMB({emb_0_embbag_dedw_grad_inter, emb_0_embbag_weight, emb_0_embbag_momentum, emb_0_embbag_dedw_param_table_indices, emb_0_offset_shape, emb_0_embbag_timestamp, emb_0_embbag_rate, emb_0_embbag_valid_indices, emb_0_embbag_valid_indices}, {emb_0_embbag_dedw_weight_output, emb_0_embbag_dedw_momentum_output}, "emb_0_embbag_dedw_EMB", "embedding_bag_sgd_bwd_f32", graphHandle, emb_0_embbag_dedw_EMB_kernel_params);
    emb_0_embbag_dedw_EMB.createNode();


    // generate graph
    SetTestFileName("dlrm_EmbeddingBag_dedw_float32");
    LaunchInfo launchInfo = compileAllocateAndLoadGraph(graphHandle);
    TensorInfoList graph_inputs;
    TensorInfoList graph_outputs;
    ...
    {
        float* ref_arr = new float[emb_0_embbag_weight->getNumberOfElements()];
        void* data = nullptr;
        status = synHostMalloc(deviceId, emb_0_embbag_weight->getTotalSizeInBytes(), 0, &data);
        ASSERT_TRUE(status == synSuccess && "synHostMalloc failed");
        float* typed_data = static_cast<float*>(data);
        bool file_res = read_file("/software/dlrm_traininig/sw_extracted_tensors/emb_0_embbag_dedw_weight_output", ref_arr, emb_0_embbag_weight->getNumberOfElements());
        (void)file_res;
        if (file_res)
        {
            uploadTensorData(emb_0_embbag_weight->getDramAddress(), data, emb_0_embbag_weight->getTotalSizeInBytes());
            LOG_WARN(SYN_TEST, "validating: emb_0_embbag_weight");
            validateResult(ref_arr, typed_data, emb_0_embbag_weight->getNumberOfElements());
        } else {
