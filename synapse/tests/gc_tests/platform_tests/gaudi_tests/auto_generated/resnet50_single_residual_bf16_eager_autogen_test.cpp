...
TEST_F_GC(SynGaudi2ResNetTestEager, DISABLED_resnet50_single_residual_bf16_eager_ASIC_CI)
{
    ...
    synTensor layer1_0_conv1_output = createTensor(4U, syn_type_bf16, layer1_0_conv1_output_sizes, false, "layer1_0_conv1_output");
    ...
    synTensor layer1_0_conv2_output = createTensor(4U, syn_type_bf16, layer1_0_conv2_output_sizes, false, "layer1_0_conv2_output");
    ...
    /*************
     * layer1_0_bn2 node
     * inputs: [layer1_0_conv2_output(64, 56, 56, 64)(dtype=bf16), layer1_0_bn2_bias[64](dtype=float32), layer1_0_bn2_weight[64](dtype=float32), layer1_0_bn2_running_mean[64](dtype=float32), layer1_0_bn2_running_var[64](dtype=float32)]
     * output: [layer1_0_bn2_output(64, 56, 56, 64)(dtype=bf16), layer1_0_bn2_saved_mean(1, 1, 1, 64)(dtype=float32), layer1_0_bn2_saved_var(1, 1, 1, 64)(dtype=float32)]
     *************/
    ...
    synTensor layer1_0_bn2_output = createTensor(4U, syn_type_bf16, layer1_0_bn2_output_sizes, false, "layer1_0_bn2_output");
    ...
    status = synNodeCreate(graphHandle, layer1_0_bn2_in_vec, layer1_0_bn2_out_vec, 5, 3, (void *)&layer1_0_bn2_kernel_params, sizeof(layer1_0_bn2_kernel_params), "batch_norm_fwd_bf16", "layer1_0_bn2", nullptr, nullptr);
    ...
    synTensor layer1_0_relu2_output = createTensor(4U, syn_type_bf16, layer1_0_relu2_output_sizes, false, "layer1_0_relu2_output");

    synTensor layer1_0_relu2_out_vec[1] = {layer1_0_relu2_output};


    status = synNodeCreate(graphHandle, layer1_0_relu2_in_vec, layer1_0_relu2_out_vec, 1, 1, nullptr, 0, "relu_fwd_bf16", "layer1_0_relu2", nullptr, nullptr);
    ...
    synTensor layer1_0_conv3_output = createTensor(4U, syn_type_bf16, layer1_0_conv3_output_sizes, false, "layer1_0_conv3_output");
    ...
    /*************
     * layer1_0_bn3 node
     * inputs: [layer1_0_conv3_output(64, 56, 56, 256)(dtype=bf16), layer1_0_bn3_bias[256](dtype=float32), layer1_0_bn3_weight[256](dtype=float32), layer1_0_bn3_running_mean[256](dtype=float32), layer1_0_bn3_running_var[256](dtype=float32)]
     * output: [layer1_0_bn3_output(64, 56, 56, 256)(dtype=bf16), layer1_0_bn3_saved_mean(1, 1, 1, 256)(dtype=float32), layer1_0_bn3_saved_var(1, 1, 1, 256)(dtype=float32)]
     *************/
    ...
    synTensor layer1_0_bn3_output = createTensor(4U, syn_type_bf16, layer1_0_bn3_output_sizes, false, "layer1_0_bn3_output");
    ...
    status = synNodeCreate(graphHandle, layer1_0_bn3_in_vec, layer1_0_bn3_out_vec, 5, 3, (void *)&layer1_0_bn3_kernel_params, sizeof(layer1_0_bn3_kernel_params), "batch_norm_fwd_bf16", "layer1_0_bn3", nullptr, nullptr);
    ASSERT_TRUE(status == synSuccess && "synNodeCreate for layer1_0_bn3 failed!");

    /*************
     * layer1_downsample node
     * inputs: [worker_0_maxpool_output[64, 56, 56, 64](dtype=bf16), layer1_downsample_weight[1, 1, 64, 256](dtype=bf16)]
     * output: [layer1_downsample_output(64, 56, 56, 256)(dtype=bf16)]
     *************/
    ...
    synTensor layer1_downsample_output = createTensor(4U, syn_type_bf16, layer1_downsample_output_sizes, false, "layer1_downsample_output");
    ...
    /*************
     * layer1_bn node
     * inputs: [layer1_downsample_output(64, 56, 56, 256)(dtype=bf16), layer1_bn_bias[256](dtype=float32), layer1_bn_weight[256](dtype=float32), layer1_bn_running_mean[256](dtype=float32), layer1_bn_running_var[256](dtype=float32)]
     * output: [layer1_bn_output(64, 56, 56, 256)(dtype=bf16), layer1_bn_saved_mean(1, 1, 1, 256)(dtype=float32), layer1_bn_saved_var(1, 1, 1, 256)(dtype=float32)]
     *************/
    ...
    status = synNodeCreate(graphHandle, layer1_bn_in_vec, layer1_bn_out_vec, 5, 3, (void *)&layer1_bn_kernel_params, sizeof(layer1_bn_kernel_params), "batch_norm_fwd_bf16", "layer1_bn", nullptr, nullptr);
    ...
    synTensor layer1_0_add_residual_fwd = createTensor(4U, syn_type_bf16, layer1_0_add_residual_fwd_sizes, false, "layer1_0_add_residual_fwd");

    synTensor layer1_0_add_residual_fwd0_out_vec[1] = {layer1_0_add_residual_fwd};


    status = synNodeCreate(graphHandle, layer1_0_add_residual_fwd0_in_vec, layer1_0_add_residual_fwd0_out_vec, 2, 1, nullptr, 0, "add_fwd_bf16", "layer1_0_add_residual_fwd0", nullptr, nullptr);
    ...
    status = synNodeCreate(graphHandle, layer1_0_relu3_in_vec, layer1_0_relu3_out_vec, 1, 1, nullptr, 0, "relu_fwd_bf16", "layer1_0_relu3", nullptr, nullptr);
