...
class SynGaudi3TestRotate : public SynGaudiTestInfra
{
public:
    ...
    SynGaudi3TestRotate()
    {
        ...
        {
            LOG_WARN(SYN_TEST,
                     "No device type specified in SYN_DEVICE_TYPE env variable, using default value: synDeviceGaudi3");
            m_deviceType = synDeviceGaudi3;
        }
...

{
    ...
    simCmd += ROTATOR_EXE + std::string(" -f ") + inFileName + std::string(" -di ") + inFileDir +
                          ...
                          unsigned                        crd_mode)
{
    ...
    for (int j = 0; j < num_vertical_stripes; j++)
    {
        ...
        for (int i = 0; i < num_horizontal_stripes; i++)
        {
            ...
            res = ReadBMPplain(outFileNameFullPath, imageWidthBMP, imageHeightBMP, &inputImageDataBMP, true);
...
void SynGaudi3TestRotate::run_test_base(int                      batch_size,
                                        int                      channel_size,
                                        float                    rotationAngle,
                                        int                      input_height,
                                        int                      input_width,
...
void SynGaudi3TestRotate::run_test(int                      batch_size,
                                   int                      channel_size,
                                   float                    rotationAngle,
                                   std::vector<std::string> inputFileName,
                                   int                      output_height,
...
TEST_F_GC(SynGaudi3TestRotate, gaudi3_rotate_30_angle, {synDeviceGaudi3})
{
...
TEST_F_GC(SynGaudi3TestRotate, gaudi3_rotate_positive_angle_32_27_crd_mode_0, {synDeviceGaudi3})
{
    // Setup the test parameters
...
TEST_F_GC(SynGaudi3TestRotate, gaudi3_rotate_positive_angle_45, {synDeviceGaudi3})
{
    // Setup the test parameters
...
TEST_F_GC(SynGaudi3TestRotate, gaudi3_rotate_0_angle, {synDeviceGaudi3})
{
    // Setup the test parameters
...
TEST_F_GC(SynGaudi3TestRotate, gaudi3_rotate_positive_angle_small_output, {synDeviceGaudi3})
{
    // Setup the test parameters
...
TEST_F_GC(SynGaudi3TestRotate, gaudi3_rotate_negative_small_angle, {synDeviceGaudi3})
{
    // Setup the test parameters
...
TEST_F_GC(SynGaudi3TestRotate, gaudi3_rotate_negative_big_angle, {synDeviceGaudi3})
{
    // Setup the test parameters
...
TEST_F_GC(SynGaudi3TestRotate, gaudi3_rotate_less_than_180_angle, {synDeviceGaudi3})
{
    // Setup the test parameters
...
TEST_F_GC(SynGaudi3TestRotate, gaudi3_rotate_180_angle, {synDeviceGaudi3})
{
    // Setup the test parameters
...
TEST_F_GC(SynGaudi3TestRotate, gaudi3_rotate_larger_than_180_angle, {synDeviceGaudi3})
{
    // Setup the test parameters
...
TEST_F_GC(SynGaudi3TestRotate, gaudi3_rotate_90deg_single_roi, {synDeviceGaudi3})
{
    // Setup the test parameters
...
TEST_F_GC(SynGaudi3TestRotate, gaudi3_rotate_270deg, {synDeviceGaudi3})
{
    // Setup the test parameters
...
TEST_F_GC(SynGaudi3TestRotate, gaudi3_rotate_unsupported_angle_single_roi, {synDeviceGaudi3})
{
    // Setup the test parameters
